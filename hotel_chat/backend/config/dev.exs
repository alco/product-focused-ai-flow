...
config :hotel_chat, HotelChatWeb.Endpoint,
  ...
  # PORT lets ../run.sh run multiple instances in parallel (one per git
  # worktree) without colliding — see the "PORTS" section of ../README.md.
  http: [ip: {127, 0, 0, 1}, port: String.to_integer(System.get_env("PORT", "4000"))],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "faOc0GnsTJo+aziPh3qzT5RwY2QPZzC8DkuEaNBpTAui5KHTnQwdbr59AYETajuo",
  watchers: []
...
config :hotel_chat, dev_routes: true
